...
- `specification`: shared app specification guidance plus child workflows for bootstrap, User Flow Specs, Domain and State Model artifacts, and consistency review.
